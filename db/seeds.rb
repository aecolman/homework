...
Book.delete_all
ba = Book.create(:author_id => aa.id, :title => "Americanah", :price => 20)
bb = Book.create(:author_id => ab.id, :title => "Orphan Train", :price => 26)
bc = Book.create(:author_id => ac.id, :title => "King And Maxwell", :price => 35)
bd = Book.create(:author_id => ad.id, :title => "Paris", :price => 38)
be = Book.create(:author_id => ae.id, :title => "Beautiful Day", :price => 16)
bf = Book.create(:author_id => af.id, :title => "The Burgess Boys", :price => 15)
bg = Book.create(:author_id => ag.id, :title => "A Game Of Thrones", :price => 24)
bh = Book.create(:author_id => ah.id, :title => "Dark Places", :price => 15)
bi = Book.create(:author_id => ai.id, :title => "Beautiful Ruins", :price => 14)
bj = Book.create(:author_id => aj.id, :title => "Me Before You", :price => 18)
bk = Book.create(:author_id => ak.id, :title => "Fly Away", :price => 23)
bl = Book.create(:author_id => al.id, :title => "The Light Between Oceans", :price => 25)
bm = Book.create(:author_id => am.id, :title => "The Interestings", :price => 27)
bn = Book.create(:author_id => an.id, :title => "Shadow Spell", :price => 15)
bo = Book.create(:author_id => an.id, :title => "Whiskey Beach", :price => 22)
bp = Book.create(:author_id => ao.id, :title => "The Alchemist", :price => 12)
bq = Book.create(:author_id => ap.id, :title => "The White Princess", :price => 24)
br = Book.create(:author_id => aq.id, :title => "Four Friends", :price => 20)
bs = Book.create(:author_id => ar.id, :title => "A Tale For The Time Being", :price => 34)
